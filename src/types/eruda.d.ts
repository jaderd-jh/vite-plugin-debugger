...
declare module 'eruda' {
  ...
  export interface Settings extends Tool {
     ...
     */
    range(cfg: object, name: string, desc: string, options?: SettingsRangeOptions): void
  ...
  export interface ErudaApis {
    ...
    get(name: string): InstanceType<EntryBtnConstructor> | InstanceType<DevToolsConstructor> | undefined

    /**
     * Add tool.
     */
    add<T extends ToolConstructor>(tool: InstanceType<T> | ((eruda: Eruda) => InstanceType<T>)): Eruda | undefined
